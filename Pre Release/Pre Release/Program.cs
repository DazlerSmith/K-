    ...
    class Breakthrough
    {
        ...
        public void PlayGame()
        {
            ...
            if (Locks.Count > 0)
            {
                ...
                while (!GameOver)
                {
                    ...
                    {
                        Console.WriteLine();
                        Console.WriteLine("Current score: " +  Score  + " , " + Deck.GetNumberOfCards() + " Cards remaining in the deck");
        ...
        private void SetupGame()
        {
            ...
            if (Choice == "L")
            {
                ...
                if (File.Exists(Console.ReadLine()) == true)
                {
            ...
            else
            {
                ...
                do
                {
                    Console.WriteLine("Random Lock (1) or Specific Lock (2)");
